...
%    Version 2026B
%
% Contributors: Themiya Nanayakkara, Tiantian Yuan, Jeff Cooke, Deanne Fisher, Glenn Kacprzak, Michael Murphy, Rebecca Davies.
% 
...
% 	   STUDENT THESIS INVOLVEMENT, OTHER APPLICATIONS, and FUTURE APPLICATIONS.
% 	* Target lists may be attached to the proposal as a separate sheet(s) with no page limit.
% 	*  1-page maximum in total for the sections RESPONSE TO STACK FEEDBACK. 
...
\newcommand\keckcode{2026B\_WXXXX} % Modify to your specific 
                                    % proposal ID number
...
% If this is part of a longer-term project that will require nights over multiple semesters,
% address the total goals, as well as what will be done with the current proposed observations.  
...
% All proposals MUST address the following points in the description and please use the following headings:
\noindent{\bf Instrument Justification:}
...
% for ToO observations,please include all possible instruments what would 
% work for your observations.

\noindent{\bf Time Justification:}
...
%    further assumptions **
\noindent{\bf Lunar Phase and Constraints Justification:}
% -  Please justify here the requested lunar phase and other observing 
% constraints. This may include details of the visibility of the 
% targets for the requested nights. Ensure that the number of hours the 
% field is above the Nasmyth platforms is consistent with observing 
% requests (rising or setting limits imposed by Keck I and Keck II).
% See http://www2.keck.hawaii.edu/inst/common/TelLimits.html for
% details.  

\noindent{\bf ToO Justification:}
% comment out if not needed. Please include ToO related justifications here,
% which will include where the triggers come from, what criteria they have to fulfil, 
% the required response times, probibility of tiggering, and what if any other 
% conditions must be met. 

% Back up programs for all proposers: 
...
%\bigskip
\clearpage
\noindent{\bf RESPONSE TO STACK FEEDBACK:}    % - DO NOT EDIT 
\\ {\em A total of 1 page maximum is allowed for the RESPONSE TO STACK FEEDBACK. Remove page if not used.}

% INSTRUCTIONS: This is an optional section to respond to STACK feedback on a re-submitted proposal. Remove page if not used. Please include a summary of the referee report and state the points being addressed. Assume the panel will not have direct access to the reports when reading the proposal. 
