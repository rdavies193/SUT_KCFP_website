...
%    Version 2024B.v1
%
% Contributors: Themiya Nanayakkara, Tiantian Yuan, Jeff Cooke, Deanne Fisher, Glenn Kacprzak, Michael Murphy.
% 
...
\newcommand\keckcode{202BA\_WXXXX} % Modify to your specific 
                                    % proposal ID number
...
% a re-submitted proposal. Remove page if not used. Please include a summary of the referee report and state the points being addressed. Assume the panel will not have direct access to the reports when reading the proposal. 
