...
% Scientific Justification section and 1-page maximum for the 
% Technical Feasibility and Flexibility & Minimum Time sections.  
...
\newcommand\keckcode{2015A\_W000XX} % Modify to your specific 
                                    % proposal ID number
...
\noindent{\bf PREVIOUS STACK ALLOCATION OUTCOMES:} % - DO NOT REMOVE

% INSTRUCTIONS: Specify any/all previous Keck allocations to the PI and
% any of the CoIs of this proposal.  Please fill in the example table
% shown below.  Additionally, describe the outcomes from those
...
% The lack of publications for completed projects will considered in the
% ranking of the PIs proposals.
