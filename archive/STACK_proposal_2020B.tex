...
%    Version 2020B.v1
%
% Adapted from the previous Swinburne TAC Keck form by Tiantian Yuan, 
% Jeff Cooke, Deanne Fisher and Michael Murphy
...
% INVOLVEMENT, OTHER APPLICATIONS, RESPONSE TO STACK FEEDBACK, and FUTURE APPLICATIONS.
...
\newcommand\keckcode{2020B\_WXXXX} % Modify to your specific 
                                    % proposal ID number
...
% INSTRUCTIONS: 1 page MAXIMUM. The STACK cannot grant time that it cannot clearly see
...
% ***  NEW SINCE  2020A--- A maximum of 0.5 pages can be used for the justification of DDT here
...
% ranking of the PIs proposals.   The STACK will ONLY use this online database for your proposal ranking, 
