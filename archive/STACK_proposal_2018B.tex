...
%    Version 2018B.1
%
% Adapted from the previous Swinburne TAC Keck form by Jeff Cooke, David Fisher and Michael Murphy
...
% the various sections.  Overall, there is a 2-page maximum for the 
...
\newcommand\keckcode{2018B\_WXXXX} % Modify to your specific 
                                    % proposal ID number
...
% {\it Instructions:} Scientific Justification: {\bf A MAXIMUM OF TWO
